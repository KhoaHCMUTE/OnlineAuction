          ...
          <div class="col-sm-4 mb-3 ">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/home/product/byProID?ProId=${c.proID}" role="button"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;Detail</a>
                </div>
            </div>
          </div>
        </c:forEach>
